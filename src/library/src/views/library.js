(function () {
    ...
    View.prototype._createBook = function (anotherBook) {
        ...
        var rating = this._createRating(currentRating);
        $bookWrapper.appendChild(rating);

        return $bookWrapper;
    }

    View.prototype._createRating = function (currentRating) {
        let $stars = document.createElement('div');
        let currentIndex;
        this._createStar($stars, currentRating);
        // Array all stars
    ...
    View.prototype._createStar = function (stars, currentRating) {
    ...
    View.prototype._showButtonDelete = function () {
        const $searchInput = document.querySelector("#search");
